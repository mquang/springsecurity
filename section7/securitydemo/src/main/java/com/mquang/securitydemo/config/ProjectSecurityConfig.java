...
//		.csrf((csrf) -> csrf.csrfTokenRequestHandler(requestHandler).ignoringRequestMatchers("/h2-console/**", "/contact", "/register")
		.csrf((csrf) -> csrf.csrfTokenRequestHandler(requestHandler).ignoringRequestMatchers("/h2-console/**", "/register")
...
//			.requestMatchers("/myAccount", "/myBalance", "/user").authenticated()
			.requestMatchers("/myAccount", "/myBalance", "/contact", "/user").authenticated()
